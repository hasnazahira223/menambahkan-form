...
from faperta.models import UKM, JalurMasuk, MahasiswaMengikutiUKM, NilaiMahasiswa, NilaiTertinggi, Prodi
from . models import Dosen, PenerimaBeasiswa, Tenaga_Pendidik, Mahasiswa
